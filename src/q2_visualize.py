...
고해상도 이미지(PNG)로 'outputs/figures/' 폴더에 저장한다.
...
ROOT_DIR = SRC_DIR.parents[0] if SRC_DIR.name != "src" else SRC_DIR.parent
...
from eda import config  # noqa: E402
