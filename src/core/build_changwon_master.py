...
산출물
    ...
    logs/validation/preprocessing/raw_inventory.csv        원자료 구조 점검
    logs/validation/preprocessing/revision_inventory.csv   보정 전후 값 비교
    logs/validation/preprocessing/master_diff_vs_previous.csv   이전 산출물과의 차이 (있는 경우)
    logs/validation/preprocessing/latest_points.json       지표별 최신 시점
...
실행
    ...
    python src/core/build_changwon_master.py --no-compare   # 이전 산출물과의 비교 생략
"""
