...
def find_root(start=None):
    ...
    candidates = [start, *start.parents, Path(__file__).resolve().parents[3]]
...
def project_dirs(root, make=True):
    ...
    dirs = {
        ...
        'fig': root / 'outputs' / 'final_model' / '01_core' / 'figures',
        'tab': root / 'outputs' / 'final_model' / '01_core' / 'tables',
        'report': root / 'outputs' / 'final_model' / '06_report_assets',
    }
    if make:
