...
def verification_scope(root, dir_proc):
    ...
    root = Path(root)
    optional_files = [
        root / 'logs/validation/triage/vintage_수정폭_실측.csv',
        root / 'outputs/final_model/04_external_evidence/eis/창원상의_교차검증.csv',
        root / 'logs/validation/triage/결측보완_2023Q4_2024Q4_국면.csv',
