...
입력 파일:
    ...
    - logs/validation/preprocessing/exclusion_or_review_log.csv : QA 검증/리뷰 플래그 로그

출력:
    - outputs/final_model/01_core/figures/ 에 PNG 3종
...
사용법:
    python src/core/q1_state_analysis.py
"""
...
LOG_DIR = ROOT_DIR / "logs" / "validation" / "preprocessing"
FIG_DIR = ROOT_DIR / "outputs" / "final_model" / "01_core" / "figures"
FIG_DIR.mkdir(parents=True, exist_ok=True)

sys.path.insert(0, str(ROOT_DIR / "src"))
from core.analysis import config  # noqa: E402  팀 공통 설정
